...
export default function Home() {
  return (
    <div>
      ...
      <section className="relative h-[90vh]">
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Join Nova Scotia's fastest-growing Roundnet community
          </motion.p>
          <motion.div variants={fadeInUp}>
            <Link 
              href="/events"
              className="bg-primary-yellow text-primary-blue px-8 py-3 rounded-full font-bold text-lg hover:scale-105 transition-transform duration-300"
            >
              Join Our Next Event
            </Link>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <Link 
                href="/events"
                className="bg-primary-yellow text-primary-blue px-6 py-3 rounded-full font-bold hover-scale inline-block"
              >
                View Schedule
              </Link>
            </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 bg-secondary-blue">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link 
              href="/contact"
              className="bg-primary-yellow text-primary-blue px-6 py-3 rounded-full font-bold hover-scale"
            >
              Contact Us
            </Link>
            <Link 
